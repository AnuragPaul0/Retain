...
{/* textAlign: 'center', , alignSelf: 'center' */}
  ...
  "justify-center before:bg-white/10 border-white/20 border-1 overflow-hidden before:rounded-xl bottom-1 w-[calc(100%_-_8px)] ml-1 z-10"
    ...
    ><svg xmlns="http://www.w3.org/2000/svg" fill="#000" version="1.1" id="Capa_1" width="80px"
      viewBox="0 0 305.002 305.002" xmlSpace="preserve">
        <g><g><circle xmlns="http://www.w3.org/2000/svg" r="150" cx="150" cy="150" fill="green"/>
          <path xmlns="http://www.w3.org/2000/svg" d="M152.502,0.001C68.412,0.001,0,68.412,0,152.501s68.412,152.5,152.502,152.5c84.089,0,152.5-68.411,152.5-152.5    S236.591,0.001,152.502,0.001z M152.502,280.001C82.197,280.001,25,222.806,25,152.501c0-70.304,57.197-127.5,127.502-127.5    c70.304,0,127.5,57.196,127.5,127.5C280.002,222.806,222.806,280.001,152.502,280.001z" style="&#10;    fill: aqua;&#10;"/>
          <rect width="200" height="200" x="50" y="50" rx="20" ry="20" fill="green"/>
