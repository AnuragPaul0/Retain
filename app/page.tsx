  ...
  <div key='3' className='df'>
    ...
    alt="Woman" height="150" width="100"/>
      ...
      <img src="https://cdn.pixabay.com/photo/2022/11/19/14/26/nature-7602212_640.jpg"
        className="hre brr relative z-10 shadow-black/5 data-[loaded=true]:opacity-100 shadow-none transition-transform-opacity motion-reduce:transition-none !duration-300 tl0 tr0 object-cover opacity-1"
...
export default function Home() {
  ...
  spin = (e: any, swi=1) => { tr = (e.currentTarget as HTMLElement).classList; tr.add('spi')
  if (swi) setTimeout(() => { tr?.remove('spi')}, 2001 ) },
    ...
    <div style={{ width: '4rem' }} className={
      ...
      <div className="flex-col justify-start item-center"><div className="my-4">
        ...
        <div className="flex mb-8 justify-start items-center gap-4 rounded-md group cursor-pointer">
          <Button id='riq' className="h-auto mwu self-center" variant="flat" radius="none"
        ...
        <div className="flex justify-start items-center gap-4 rounded-md group">
          <Button id='riq' className="br5 h-auto mb-8 mwu self-center" variant="flat" radius="none"
            ><svg id='Meta' fill='white' viewBox="0 0 30 20" width="40px"><desc>Logo of Meta</desc>
              ...
              <path id="Logo1" d="m24.49,37.3c14.24-21.95 34.79-37.3 58.36-37.3 13.65,0 27.22,4.04 41.39,15.61 15.5,12.65 32.02,33.48 52.63,67.81l7.39,12.32c17.84,29.72 27.99,45.01 33.93,52.22 7.64,9.26 12.99,12.02 19.94,12.02 17.63,0 22.03-16.2 22.03-34.74l27.4-.86c0,19.38-3.82,33.62-10.32,44.87-6.28,10.88-18.52,21.75-39.11,21.75-12.8,0-24.14-2.78-36.68-14.61-9.64-9.08-20.91-25.21-29.58-39.71l-25.79-43.08c-12.94-21.62-24.81-37.74-31.68-45.04-7.39-7.85-16.89-17.33-32.05-17.33-12.27,0-22.69,8.61-31.41,21.78z"/>
              <path id="Logo2" d="m82.35,31.23c-12.27,0-22.69,8.61-31.41,21.78-12.33,18.61-19.88,46.33-19.88,72.95 0,10.98 2.41,19.41 5.56,24.51l-26.48,17.44c-6.8-11.31-10.14-26.15-10.14-43.06 0-30.75 8.44-62.8 24.49-87.55 14.24-21.95 34.79-37.3 58.36-37.3z"/>
        </g></svg></Button></div>

        <div className="flex justify-start items-center gap-4 pl-1 rounded-md group cursor-pointer m-auto">
          <Button id='riq' className="h-auto mb-8 mwu self-center" variant="flat" radius="none"
            ><svg id='Shopify'width="98" viewBox="0 0 163 173.7" role="img"><title>Shopify</title>
              <path id='ful' fill="white" d="M130.7 32.9c-.1-.9-.9-1.3-1.5-1.4-.6-.1-12.6-.2-12.6-.2s-10.1-9.8-11.1-10.8-2.9-.7-3.7-.5c0 0-1.9.6-5.1 1.6-.5-1.7-1.3-3.8-2.4-5.9-3.6-6.9-8.8-10.5-15.2-10.5-.4 0-.9 0-1.3.1-.2-.2-.4-.4-.6-.7-2.8-3-6.3-4.4-10.5-4.3-8.2.2-16.3 6.1-23 16.7-4.7 7.4-8.2 16.7-9.2 23.9-9.4 2.9-16 4.9-16.1 5-4.7 1.5-4.9 1.6-5.5 6.1C12.4 55.3 0 151.4 0 151.4l104.1 18 45.1-11.2S130.8 33.7 130.7 32.9zm-39.2-9.7c-2.4.7-5.1 1.6-8.1 2.5-.1-4.1-.6-9.9-2.5-14.9 6.3 1.2 9.3 8.2 10.6 12.4zM78 27.4c-5.5 1.7-11.4 3.5-17.4 5.4 1.7-6.4 4.9-12.8 8.8-17 1.5-1.6 3.5-3.3 5.9-4.3 2.3 4.7 2.7 11.4 2.7 15.9zM66.8 5.8c1.9 0 3.5.4 4.9 1.3-2.2 1.1-4.4 2.8-6.4 5-5.2 5.6-9.2 14.2-10.8 22.6-5 1.5-9.8 3-14.3 4.4 3-13.2 14-32.9 26.6-33.3z"></path>
  ...
  "foo justify-center before:bg-white/10 overflow-hidden py-1 before:rounded-xl bottom-1 w-[calc(100%_-_8px)] ml-1 z-10">
      <p className="text-tiny" style={{ marginBottom: 0 }}
        >Multi Image - fallback</p></CardFooter></Card></Col>
 ...
 "M484.1,454.796l-110.5-110.6c29.8-36.3,47.6-82.8,47.6-133.4c0-116.3-94.3-210.6-210.6-210.6S0,94.496,0,210.796   s94.3,210.6,210.6,210.6c50.8,0,97.4-18,133.8-48l110.5,110.5c12.9,11.8,25,4.2,29.2,0C492.5,475.596,492.5,463.096,484.1,454.796z    M41.1,210.796c0-93.6,75.9-169.5,169.5-169.5s169.6,75.9,169.6,169.5s-75.9,169.5-169.5,169.5S41.1,304.396,41.1,210.796z"/>
        ...
        </div><Button onClick={ () => myFunction() } id='buno' className=
          {'action-label mwu close h-auto z-10 shadow-medium self-center p-2'+
