    ...
    <div style={{ width: '4rem' }} className={
      ...
      <div className="flex-col justify-start item-center"><div className="my-4">
        ...
        <div className="flex mb-8 justify-start items-center gap-4 rounded-md group cursor-pointer">
          <Button id='riq' className="br5 h-auto mwu self-center" variant="flat" radius="none"
        ...
        <div className="flex justify-start items-center gap-4 pl-1 rounded-md group cursor-pointer m-auto">
          <Button id='riq' className="mb-8 mwu self-center" variant="flat" radius="none"
            ><svg id='Shopify'width="98" viewBox="0 0 208 173.7" role="img"><title>Shopify</title>
        ...
        <div className="my-4 pb-4 " style={{ position: 'absolute', bottom: 0 }}>
          <div className="flex mb-2 justify-start items-center gap-4 pl-1 rounded-md group cursor-pointer m-auto">
