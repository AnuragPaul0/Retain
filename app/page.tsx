...
updateDarkMode = () => { localStorage.setItem("mode", 'light'); //save it in local storage
  let d=document.documentElement, c=d.classList //now update our styles!
}
      ...
      <nav aria-label="Vercel Directory"><div className="statusRow">
        <fieldset className="tailwind root" data-small="">
          <legend className="sr-only">Select a display theme:</legend><span>
            ...
            <input onClick={ () => myFunction([''], 0) } name="state" aria-label="light"
            ...
            <input name="state" aria-label="dark" id="theme-switch-dark-:R2jcj9am:" type="radio"
              value="dark"/>
